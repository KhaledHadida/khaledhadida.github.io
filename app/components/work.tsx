...
export default function work() {
    ...
    return (
        <div id="work" className="flex flex-col justify-center items-center scroll-mt-[150px] max-w-[75%] m-auto">
            ...
            <div className='flex-col space-y-7 w-full m-5'>
                {Jobs.map((job: Job, index) => (
                    <div key={index} className={`flex rounded-lg items-center justify-between ${index % 2 ? 'flex-row-reverse bg-gradient-to-l from-orange rounded-r-full': 'bg-gradient-to-r from-orange rounded-s-full'}`}>
